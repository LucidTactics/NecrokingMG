...
public static class ScenarioRegistry
{
    ...
    static ScenarioRegistry()
    {
        ...
        Register("item_consume", () => new Scenarios.ItemConsumeScenario());
        ...
        Register("occlusion_fade", () => new Scenarios.OcclusionFadeScenario());
        ...
        Register("whiff_on_escape", () => new Scenarios.WhiffOnEscapeScenario());
        ...
        Register("balance_matrix", () => new Scenarios.BalanceMatrixScenario());
    }
