...
internal class ReanimEffectSystem
{
    ...
    private static List<ReanimConfig> BuildPresets()
    {
        ...
        {
            Id = "reanim_smoke", OutlineDuration = 6.2f, LightDuration = 5.0f, SpawnWindow = 1.0f, PuffAnimCycles = 1.4f,
            ...
            CloudColor = Green(55, 170, 85, 220, 1.1f), CloudWorldSize = 2.04f, CloudCount = 11, CloudRise = 1.0f, CloudLifetime = 6.5f,
            DustColor = Green(55, 50, 45, 220, 1.0f), DustWorldSize = 1.95f, DustCount = 12, DustRise = 0.9f, DustLifetime = 6.5f, DustMaxAlpha = 0.5f,
        });
