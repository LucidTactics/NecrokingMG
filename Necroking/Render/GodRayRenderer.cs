...
public class GodRayRenderer
{
    ...
    // (DrawGodRaySpriteBatch — the hand-kept low-fi SpriteBatch mirror for the
    // spell-editor preview — was removed 2026-07-12: SpellPreview now owns a
    // GodRayRenderer instance and renders god rays through this real triangle
    // path, so the preview can no longer drift from the in-game look.)
